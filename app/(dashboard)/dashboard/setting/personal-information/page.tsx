        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-end mb-[10px]">
              <Link
                href={`/dashboard/setting/personal-information/${1}`}
                className="bg-[#08A270] text-white px-[30px] py-[10px] rounded-full flex items-center gap-2 hover:bg-[#07a270] transition-colors"
              >
                <Pencil size={16} />
            ...
            <div className="space-y-6">
              ...
              {/* Phone Number Field */}
              <div>
                <label className="block font-medium mb-4">Phone Number</label>
